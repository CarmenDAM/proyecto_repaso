      ...
      render(){
        ...
        */
        ...
        <div className="fondoI">
                ...
                <h2>Cantidad: </h2>
                <TextField id="cantidadI" label="Cantidad" variant="standard" />
                
                <h2>Tipo: </h2>
                <TextField id="tipoI" label="Tipo" variant="standard" />

                <h2>Descripción: </h2>
                <TextField id="descripcionI" label="Descripción" variant="standard" />

                <h2>Fecha: </h2>
                <TextField id="fechaI" label="Fecha" variant="standard" />
